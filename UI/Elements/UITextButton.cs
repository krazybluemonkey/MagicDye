...
public class UITextButton : UIElement // vaguely based around the change & cancel button from the dresser UI + UIText
{
    ...
    public UITextButton(LocalizedText text, float textScale = 1f, bool large = false)
    {
        TextOriginX = 0.5f;
        TextOriginY = 0f;
        IsWrapped = false;
